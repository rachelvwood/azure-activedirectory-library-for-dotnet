...
namespace WinFormsAutomationApp
{
    public partial class MainForm : Form
    {
        ...
        {
            string output = await AuthenticationHelper.ReadCacheAsync().ConfigureAwait(false); ;
            pageControl1.SelectedTab = resultPage;
            resultInfo.Text = output;
            resultLogs.Text = GetAdalLogs();
        }
        ...
        {
            string output = await AuthenticationHelper.ClearCacheAsync(null).ConfigureAwait(false);
            pageControl1.SelectedTab = resultPage;
            resultInfo.Text = output;
            resultLogs.Text = GetAdalLogs();
        }
